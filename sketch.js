  ...
  function setup() {
    ...
    boy = new Boy(250,600);
    chain = new Chain(stone.body,{x:250, y:460});

    Engine.run(engine);

    ul = createSprite(100,130,80,0.1)
  ...
  function draw() {
    ...
    background(280,345,2)
    
    fill('black');
    textSize(28);
    text("PRESS SPACE TO GET A SECOND CHANCE TO PLAY", 200,200);
    text("AND ENJOY THE GAME BY PLUCKING MANGOES",200,300);
   // text("MANGO PLUCKING GAME FOR SHREYA APRULA",100,100);
